...
type INoteRepository interface {
	...
	FindByNoteTypeID(ctx context.Context, userID int64, noteTypeID int64) ([]*note.Note, error)
	...
	FindByTags(ctx context.Context, userID int64, tags []string) ([]*note.Note, error)
}
